...
my $DEFAULT_PID_DIR  = "${HLQUERY_PID_DIR}";
my $DEFAULT_LOGDIR = "${HLQUERY_LOG_DIR}";
...
sub find_binary {
    ...
    my $fixed_binary = "${HLQUERY_BIN_DIR}/" . $BINARY_NAME;
    if (-x $fixed_binary) {
        return $fixed_binary;
    }
